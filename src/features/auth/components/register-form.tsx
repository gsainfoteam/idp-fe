        ...
        <div className="flex justify-center h-screen">
            <div className="flex flex-col p-[20px] pt-[24px] w-[361px]">
                <div className="flex flex-col">
                    ...
                    <span className="text-label-1 mb-1 mt-2.5 text-[#3d3d3d]">
                        GIST 이메일
                    </span>
                    <input
                        className={`border-1 mb-0.5 rounded-sm p-2 px-2.5 ${formState.errors.email
                                ? 'border-red-600 placeholder-red-600 text-red-600'
                                : 'border-[#888888] placeholder-[#888888]'
                            }`}
                        {...register('email')}
                        type="email"
                    ...
                    <input
                        className={`border-1 mb-0.5 rounded-sm p-2 px-2.5 ${formState.errors.password
                                ? 'border-red-600 placeholder-red-600 text-red-600'
                                : 'border-[#888888] placeholder-[#888888]'
                            }`}
                        {...register('password')}
                    ...
                    <input
                        className={`border-1 mb-0.5 rounded-sm p-2 px-2.5 ${formState.errors.passwordConfirm
                                ? 'border-red-600 placeholder-red-600 text-red-600'
                                : 'border-[#888888] placeholder-[#888888]'
                            }`}
                    ...
                    <input
                        className={`border-1 mb-0.5 rounded-sm p-2 px-2.5 ${formState.errors.name
                                ? 'border-red-600 placeholder-red-600 text-red-600'
                                : 'border-[#888888] placeholder-[#888888]'
                            }`}
                        {...register('name')}
                    ...
                    <input
                        className={`border-1 mb-0.5 rounded-sm p-2 px-2.5 ${formState.errors.studentId
                                ? 'border-red-600 placeholder-red-600 text-red-600'
                                : 'border-[#888888] placeholder-[#888888]'
                            }`}
                        {...register('studentId')}
                    ...
                    <input
                        className={`border-1 mb-0.5 rounded-sm p-2 px-2.5 ${formState.errors.phoneNumber
                                ? 'border-red-600 placeholder-red-600 text-red-600'
                                : 'border-[#888888] placeholder-[#888888]'
                            }`}
                ...
                <button
                    type="submit"
                    className={`p-2.5 text-white rounded-md mb-[24px] ${hasErrors ? 'bg-[#888888]' : 'bg-[#ff4500]'}`}
                >
                    다음으로
                </button>
            </div>
